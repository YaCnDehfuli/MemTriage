...
export function AnalystNotice() {
  ...
  // No Escape dismissal: this gates on an explicit "I understand" click, not
  // a click-away/Escape the analyst could trigger without reading it.
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/50 p-4 backdrop-blur-sm">
      <section
        ...
        className="w-full max-w-2xl rounded-lg border border-risk-medium/40 bg-surface-900 p-5 shadow-panel"
      >
        <div className="eyebrow text-risk-medium">Analyst notice</div>
        <h2 id="volmemlyzer-notice-title" className="mt-2 text-xl font-semibold text-ink-100">
        ...
        <ul className="mt-4 space-y-2 text-[13px] leading-relaxed text-ink-300">
